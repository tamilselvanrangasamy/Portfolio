        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              Hi, my name is <span className="yellow">Tamilselvan Rangasamy </span>
              ...
              <br />
              <br />
              A highly experienced and skilled <b className="yellow"> React developer</b> with a passion for building scalable, efficient, androbust applications. Proficient in<b className="yellow"> Material UI</b>, I craft visually stunning and responsive interfaces with ease. With expertise in <b className="yellow"> Jest and Enzyme </b>, I ensure top-notch code quality through rigorous and comprehensive unit testing. My skills include modular component-driven architecture, effective state management, and optimized performance
